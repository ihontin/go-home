...
func tableCheck() []SubSliceCheck {
	var genTable = []SubSliceCheck{
		{[]int{1, 2, 3, 4, 5, 2, 3, 4}, 1, []int{4, 1, 2, 3, 4, 5, 2, 3}},
		{[]int{0, 4, 7, 54, 35}, 0, []int{35, 0, 4, 7, 54}},
		{[]int{}, 0, []int{}},
	}
	return genTable
}
...
func TestShift(t *testing.T) {
	...
	for _, ch := range testCheck {
		if gotX, got := Shift(ch.received); !reflect.DeepEqual(got, ch.expected) || gotX != ch.expectedX {
